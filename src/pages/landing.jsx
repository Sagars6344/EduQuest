  ...
  return (
    <div className="relative min-h-screen bg-amber-100 overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        {/* ✅ FIXED IMAGES */}
        <img src={sparkle} alt="" className="w-20 h-10 absolute top-[30%] left-[65%]"/>
        <img src={sparkle} alt="" className="w-20 h-10 absolute top-[100%] left-[25%]"/>
        <img src={boy} alt="" className="absolute top-[100%] left-[46%]"/>
        ...
        <div className="m-60 flex flex-col items-center justify-center gap-5 text-black text-center">
          ...
          <RetroButton 
            text="Get Started" 
            onClick={() => navigate("/EduQuest/intro")} 
          />
        </div>
      </div>
      ...
      >
        <div className="w-64 h-auto">
          {/* ✅ FIXED */}
          <RetroCards title='Welcome' desc='It will be a fun adventure' source={landing}/>
        </div>
      </div>  

      <div className="absolute bottom-10 left-4 z-20 transform rotate-10 skew-x-2">
        <RetroArea />
      </div>

      <div className="absolute bottom-8 right-8 z-20 transform -rotate-8 skew-x-6">
        <RetroAccordion />
      </div>
    </div>
  );
